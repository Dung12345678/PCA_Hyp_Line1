...
namespace BMS
{
    public static class Global
    {
        ...
        static string _ConnectionString = @"Server=172.21.9.248;Database=SumitomoHyp;uid=sa;pwd=sumi@sumi#;";
        //static string _ConnectionString = @"Server=DESKTOP-2PBD6IC\SQLEXPRESS;Database=SumitomoHyp;uid=sa;pwd=123@123a;";
