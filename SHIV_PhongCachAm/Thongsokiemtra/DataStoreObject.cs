...
namespace SHIV_PhongCachAm
{
    public class DataStoreObject : ObservableObject
    {
        ...
        public valueObject GiatriThuan { get { return giatriThuan; } set { giatriThuan = value; OnPropertyChanged("GiatriThuan"); } }
        public valueObject GiatriNghich { get { return giatriNghich; } set { giatriNghich = value; OnPropertyChanged("GiatriNghich"); } }
        public valueDanhgiaOKNG GiatriDanhgia { get { return giatriDanhgia; } set { giatriDanhgia = value; OnPropertyChanged("GiatriDanhgia"); } }
        ...
        public void Update(object sender, PropertyChangedEventArgs e)
        {
			...
			{
				giatriLech.Value = (float)Math.Floor(_doLech);
			}
